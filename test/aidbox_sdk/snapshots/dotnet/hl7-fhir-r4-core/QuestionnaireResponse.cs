...
public class QuestionnaireResponse : DomainResource, IResource
{
    ...
    public class QuestionnaireResponse_Item_Item_Answer : BackboneElement
    {
    ...
    public class QuestionnaireResponse_Item_Item : BackboneElement
    {
        public string[]? Item { get; set; }
        public string? Text { get; set; }
        public QuestionnaireResponse_Item_Item_Answer[]? Answer { get; set; }
        public required string LinkId { get; set; }
        public string? Definition { get; set; }
    }

    public class QuestionnaireResponse_Item_Answer_Item_Answer : BackboneElement
    {
        public Base.ResourceReference? ValueReference { get; set; }
        public string? ValueUri { get; set; }
        public string? ValueTime { get; set; }
    ...
    public class QuestionnaireResponse_Item_Answer_Item : BackboneElement
    {
        public string[]? Item { get; set; }
        public string? Text { get; set; }
        public QuestionnaireResponse_Item_Answer_Item_Answer[]? Answer { get; set; }
        public required string LinkId { get; set; }
        public string? Definition { get; set; }
    }
    ...
    public class QuestionnaireResponse_Item_Answer : BackboneElement
    {
        ...
        public QuestionnaireResponse_Item_Answer_Item[]? Item { get; set; }
        public string? ValueString { get; set; }
        public bool? ValueBoolean { get; set; }
        public string? ValueDateTime { get; set; }
        public string? ValueDate { get; set; }
    ...
    {
        public QuestionnaireResponse_Item_Item[]? Item { get; set; }
        public string? Text { get; set; }
