...
public class MedicinalProductPackaged : DomainResource, IResource
{
    ...
    public class MedicinalProductPackaged_PackageItem_PackageItem : BackboneElement
    {
    ...
    public class MedicinalProductPackaged_PackageItem : BackboneElement
    {
        ...
        public required Base.Quantity Quantity { get; set; }
        public Base.ProdCharacteristic? PhysicalCharacteristics { get; set; }
        public MedicinalProductPackaged_PackageItem_PackageItem[]? PackageItem { get; set; }
    }
}