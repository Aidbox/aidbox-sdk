...
public class CapabilityStatement : DomainResource, IResource
{
    ...
    public class CapabilityStatement_Rest_Operation : BackboneElement
    {
        public required string Name { get; set; }
        public required string Definition { get; set; }
        public string? Documentation { get; set; }
    ...
    public class CapabilityStatement_Rest_SearchParam : BackboneElement
    {
        public required string Name { get; set; }
        public required string Type { get; set; }
        public string? Definition { get; set; }
    ...
    public class CapabilityStatement_Rest : BackboneElement
    {
        ...
        public CapabilityStatement_Rest_Operation[]? Operation { get; set; }
        public string[]? Compartment { get; set; }
        public CapabilityStatement_Rest_Interaction[]? Interaction { get; set; }
        public CapabilityStatement_Rest_SearchParam[]? SearchParam { get; set; }
        public string? Documentation { get; set; }
    }
}