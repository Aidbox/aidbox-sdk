...
public class TestScript : DomainResource, IResource
{
    ...
    public class TestScript_Teardown_Action_Operation_RequestHeader : BackboneElement
    {
        public required string Field { get; set; }
        public required string Value { get; set; }
    }

    public class TestScript_Teardown_Action_Operation : BackboneElement
    {
        public string? Description { get; set; }
        public string? Method { get; set; }
        public string? TargetId { get; set; }
        public TestScript_Teardown_Action_Operation_RequestHeader[]? RequestHeader { get; set; }
        public string? Params { get; set; }
        public Base.Coding? Type { get; set; }
        public string? RequestId { get; set; }
        public required bool EncodeRequestUrl { get; set; }
    ...
    {
        public required TestScript_Teardown_Action_Operation Operation { get; set; }
    }
    ...
    public class TestScript_Test_Action_Assert : BackboneElement
    {
        public string? Response { get; set; }
        public string? Description { get; set; }
        public string? Path { get; set; }
    ...
    public class TestScript_Test_Action_Operation_RequestHeader : BackboneElement
    {
        public required string Field { get; set; }
        public required string Value { get; set; }
    }

    public class TestScript_Test_Action_Operation : BackboneElement
    {
        public string? Description { get; set; }
        public string? Method { get; set; }
        public string? TargetId { get; set; }
        public TestScript_Test_Action_Operation_RequestHeader[]? RequestHeader { get; set; }
        public string? Params { get; set; }
        public Base.Coding? Type { get; set; }
        public string? RequestId { get; set; }
        public required bool EncodeRequestUrl { get; set; }
    ...
    {
        public TestScript_Test_Action_Assert? Assert_ { get; set; }
        public TestScript_Test_Action_Operation? Operation { get; set; }
    }
