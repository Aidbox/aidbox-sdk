...
public class ConceptMap : DomainResource, IResource
{
    ...
    public object? Source    
    {
        ...
        set
        {
            ...
            {
                SourceCanonical = (string)value;return;
            }
    
            if (value?.GetType() == typeof(string))
            {
                SourceUri = (string)value;return;
            }
    ...
    public object? Target    
    {
        ...
        set
        {
            if (value?.GetType() == typeof(string))
            {
                TargetUri = (string)value;return;
            }
    
            if (value?.GetType() == typeof(string))
            {
                TargetCanonical = (string)value;return;
            }
    ...
    public class ConceptMap_Group_Element_Target_Product : BackboneElement
    {
    ...
    public class ConceptMap_Group_Element_Target : BackboneElement
    {
        ...
        public string? Display { get; set; }
        public ConceptMap_Group_Element_Target_Product[]? Product { get; set; }
