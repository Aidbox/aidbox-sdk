    ...
    public class ResearchElementDefinition_Characteristic : BackboneElement
    {
        ...
        public object? StudyEffective    
        {
            ...
            set
            {
                if (value?.GetType() == typeof(string))
                {
                    StudyEffectiveTiming = (string)value;return;
                }
        
                if (value?.GetType() == typeof(string))
                {
                    StudyEffectiveDuration = (string)value;return;
                }
        
                if (value?.GetType() == typeof(Base.Period))
                {
                    StudyEffectivePeriod = (Base.Period)value;return;
                }
        
                if (value?.GetType() == typeof(string))
                {
                    StudyEffectiveDateTime = (string)value;return;
                }
