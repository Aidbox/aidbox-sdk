...
public class Procedure : DomainResource, IResource
{
    ...
    public object? Performed    
    {
        ...
        set
        {
            ...
            {
                PerformedAge = (string)value;return;
            }
    
            if (value?.GetType() == typeof(string))
            {
                PerformedString = (string)value;return;
            }
    
            if (value?.GetType() == typeof(Base.Range))
            {
                PerformedRange = (Base.Range)value;return;
            }
    
            if (value?.GetType() == typeof(string))
            {
                PerformedDateTime = (string)value;return;
            }
    
            if (value?.GetType() == typeof(Base.Period))
            {
                PerformedPeriod = (Base.Period)value;return;
            }
