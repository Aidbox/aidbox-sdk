...
public class PlanDefinition : DomainResource, IResource
{
    ...
    public class PlanDefinition_Action_Action_RelatedAction : BackboneElement
    {
        public object? Offset    
        {
            get
    ...
    public class PlanDefinition_Action_Action_Participant : BackboneElement
    {
        public Base.CodeableConcept? Role { get; set; }
        public required string Type { get; set; }
    }

    public class PlanDefinition_Action_Action_Condition : BackboneElement
    {
        public required string Kind { get; set; }
        public Base.ResourceExpression? Expression { get; set; }
    }

    public class PlanDefinition_Action_Action_DynamicValue : BackboneElement
    {
        public string? Path { get; set; }
        public Base.ResourceExpression? Expression { get; set; }
    }

    public class PlanDefinition_Action_Action : BackboneElement
    {
        ...
        public object? Definition    
        {
            ...
            set
            {
                if (value?.GetType() == typeof(string))
                {
                    DefinitionUri = (string)value;return;
                }
        ...
        public PlanDefinition_Action_Action_RelatedAction[]? RelatedAction { get; set; }
        public Base.CodeableConcept? Type { get; set; }
        public PlanDefinition_Action_Action_Participant[]? Participant { get; set; }
        ...
        public PlanDefinition_Action_Action_Condition[]? Condition { get; set; }
        ...
        public PlanDefinition_Action_Action_DynamicValue[]? DynamicValue { get; set; }
    ...
    public class PlanDefinition_Action : BackboneElement
    {
        ...
        public Base.CodeableConcept[]? Code { get; set; }
        public string? TimingAge { get; set; }
        public PlanDefinition_Action_Action[]? Action { get; set; }
        public string? PrecheckBehavior { get; set; }
        public Base.DataRequirement[]? Input { get; set; }
        public Base.TriggerDefinition[]? Trigger { get; set; }
        public Base.ResourceReference? SubjectReference { get; set; }
