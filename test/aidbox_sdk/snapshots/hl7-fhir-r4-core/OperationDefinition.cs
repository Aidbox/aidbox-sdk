...
public class OperationDefinition : DomainResource, IResource
{
    ...
    public class OperationDefinition_Parameter_Part_ReferencedFrom : BackboneElement
    {
        public required string Source { get; set; }
        public string? SourceId { get; set; }
    }

    public class OperationDefinition_Parameter_Part_Binding : BackboneElement
    {
        public required string Strength { get; set; }
        public required string ValueSet { get; set; }
    }

    public class OperationDefinition_Parameter_Part : BackboneElement
    {
        ...
        public OperationDefinition_Parameter_Part_ReferencedFrom[]? ReferencedFrom { get; set; }
        public string? Documentation { get; set; }
        public OperationDefinition_Parameter_Part_Binding? Binding { get; set; }
    ...
    public class OperationDefinition_Parameter : BackboneElement
    {
        ...
        public required string Use { get; set; }
        public required string Name { get; set; }
        public OperationDefinition_Parameter_Part[]? Part { get; set; }
        public string? Type { get; set; }
