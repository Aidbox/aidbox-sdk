...
public class FamilyMemberHistory : DomainResource, IResource
{
    ...
    public object? Age    
    {
        ...
        set
        {
            ...
            {
                AgeRange = (Base.Range)value;return;
            }
    
            if (value?.GetType() == typeof(string))
            {
                AgeString = (string)value;return;
            }
    
            if (value?.GetType() == typeof(string))
            {
                AgeAge = (string)value;return;
            }
    ...
    public object? Deceased    
    {
        ...
        set
        {
            if (value?.GetType() == typeof(string))
            {
                DeceasedAge = (string)value;return;
            }
            ...
            if (value?.GetType() == typeof(Base.Range))
            {
                DeceasedRange = (Base.Range)value;return;
            }
    
            if (value?.GetType() == typeof(string))
            {
                DeceasedDate = (string)value;return;
            }
    
            if (value?.GetType() == typeof(string))
            {
                DeceasedString = (string)value;return;
            }
    ...
    public object? Born    
    {
        ...
        set
        {
            if (value?.GetType() == typeof(string))
            {
                BornString = (string)value;return;
            }
    
            if (value?.GetType() == typeof(Base.Period))
            {
                BornPeriod = (Base.Period)value;return;
            }
    
            if (value?.GetType() == typeof(string))
            {
                BornDate = (string)value;return;
            }
