...
public class ExplanationOfBenefit : DomainResource, IResource
{
    ...
    public Base.ResourceReference[]? Adjudication { get; set; }
    ...
    public class ExplanationOfBenefit_BenefitBalance_Financial : BackboneElement
    {
        ...
        public object? Used    
        {
            ...
            set
            {
                ...
                {
                    UsedMoney = (Base.Money)value;
                    return;
                }
        
                if (value?.GetType() == typeof(uint))
                {
                    UsedUnsignedInt = (uint)value;
                    return;
                }
        ...
        public object? Allowed    
        {
            ...
            set
            {
                if (value?.GetType() == typeof(Base.Money))
                {
                    AllowedMoney = (Base.Money)value;
                    return;
                }
        
                if (value?.GetType() == typeof(string))
                {
                    AllowedString = (string)value;
                    return;
                }
        
                if (value?.GetType() == typeof(uint))
                {
                    AllowedUnsignedInt = (uint)value;
                    return;
                }
    ...
    public class ExplanationOfBenefit_Diagnosis : BackboneElement
    {
        ...
        public object? Diagnosis    
        {
            ...
            set
            {
                ...
                {
                    DiagnosisReference = (Base.ResourceReference)value;
                    return;
                }
        
                if (value?.GetType() == typeof(Base.CodeableConcept))
                {
                    DiagnosisCodeableConcept = (Base.CodeableConcept)value;
                    return;
                }
    ...
    public class ExplanationOfBenefit_Item : BackboneElement
    {
        ...
        public object? Serviced    
        {
            ...
            set
            {
                if (value?.GetType() == typeof(string))
                {
                    ServicedDate = (string)value;
                    return;
                }
        
                if (value?.GetType() == typeof(Base.Period))
                {
                    ServicedPeriod = (Base.Period)value;
                    return;
                }
        ...
        public object? Location    
        {
            ...
            set
            {
                ...
                {
                    LocationAddress = (Base.Address)value;
                    return;
                }
        
                if (value?.GetType() == typeof(Base.CodeableConcept))
                {
                    LocationCodeableConcept = (Base.CodeableConcept)value;
                    return;
                }
        
                if (value?.GetType() == typeof(Base.ResourceReference))
                {
                    LocationReference = (Base.ResourceReference)value;
                    return;
                }
    ...
    public class ExplanationOfBenefit_Procedure : BackboneElement
    {
        ...
        public object? Procedure    
        {
            ...
            set
            {
                if (value?.GetType() == typeof(Base.ResourceReference))
                {
                    ProcedureReference = (Base.ResourceReference)value;
                    return;
                }
        
                if (value?.GetType() == typeof(Base.CodeableConcept))
                {
                    ProcedureCodeableConcept = (Base.CodeableConcept)value;
                    return;
                }
