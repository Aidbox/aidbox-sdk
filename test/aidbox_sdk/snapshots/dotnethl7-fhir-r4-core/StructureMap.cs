...
public class StructureMap : DomainResource, IResource
{
    ...
    public class StructureMap_Group_Rule_Source : BackboneElement
    {
        ...
        public object? DefaultValue    
        {
            ...
            set
            {
                ...
                {
                    DefaultValueTime = (string)value;
                    return;
                }
        
                if (value?.GetType() == typeof(Base.DataRequirement))
                {
                    DefaultValueDataRequirement = (Base.DataRequirement)value;
                    return;
                }
        
                if (value?.GetType() == typeof(Base.Money))
                {
                    DefaultValueMoney = (Base.Money)value;
                    return;
                }
        
                if (value?.GetType() == typeof(Base.ContactPoint))
                {
                    DefaultValueContactPoint = (Base.ContactPoint)value;
                    return;
                }
        
                if (value?.GetType() == typeof(Base.Meta))
                {
                    DefaultValueMeta = (Base.Meta)value;
                    return;
                }
        
                if (value?.GetType() == typeof(Base.Coding))
                {
                    DefaultValueCoding = (Base.Coding)value;
                    return;
                }
        
                if (value?.GetType() == typeof(string))
                {
                    DefaultValueCode = (string)value;
                    return;
                }
        
                if (value?.GetType() == typeof(Base.SampledData))
                {
                    DefaultValueSampledData = (Base.SampledData)value;
                    return;
                }
        
                if (value?.GetType() == typeof(string))
                {
                    DefaultValueMarkdown = (string)value;
                    return;
                }
        
                if (value?.GetType() == typeof(Base.HumanName))
                {
                    DefaultValueHumanName = (Base.HumanName)value;
                    return;
                }
        
                if (value?.GetType() == typeof(string))
                {
                    DefaultValueDuration = (string)value;
                    return;
                }
        
                if (value?.GetType() == typeof(string))
                {
                    DefaultValueDecimal = (string)value;
                    return;
                }
        
                if (value?.GetType() == typeof(string))
                {
                    DefaultValueUri = (string)value;
                    return;
                }
        
                if (value?.GetType() == typeof(Base.Quantity))
                {
                    DefaultValueQuantity = (Base.Quantity)value;
                    return;
                }
        
                if (value?.GetType() == typeof(string))
                {
                    DefaultValueCount = (string)value;
                    return;
                }
        
                if (value?.GetType() == typeof(string))
                {
                    DefaultValueId = (string)value;
                    return;
                }
        
                if (value?.GetType() == typeof(string))
                {
                    DefaultValueBase64Binary = (string)value;
                    return;
                }
        
                if (value?.GetType() == typeof(Base.ContactDetail))
                {
                    DefaultValueContactDetail = (Base.ContactDetail)value;
                    return;
                }
        
                if (value?.GetType() == typeof(bool))
                {
                    DefaultValueBoolean = (bool)value;
                    return;
                }
        
                if (value?.GetType() == typeof(Base.Period))
                {
                    DefaultValuePeriod = (Base.Period)value;
                    return;
                }
        
                if (value?.GetType() == typeof(Base.TriggerDefinition))
                {
                    DefaultValueTriggerDefinition = (Base.TriggerDefinition)value;
                    return;
                }
        
                if (value?.GetType() == typeof(string))
                {
                    DefaultValueDate = (string)value;
                    return;
                }
        
                if (value?.GetType() == typeof(Base.ResourceReference))
                {
                    DefaultValueReference = (Base.ResourceReference)value;
                    return;
                }
        
                if (value?.GetType() == typeof(string))
                {
                    DefaultValueDosage = (string)value;
                    return;
                }
        
                if (value?.GetType() == typeof(Base.Range))
                {
                    DefaultValueRange = (Base.Range)value;
                    return;
                }
        
                if (value?.GetType() == typeof(string))
                {
                    DefaultValueInstant = (string)value;
                    return;
                }
        
                if (value?.GetType() == typeof(Base.Attachment))
                {
                    DefaultValueAttachment = (Base.Attachment)value;
                    return;
                }
        
                if (value?.GetType() == typeof(uint))
                {
                    DefaultValueUnsignedInt = (uint)value;
                    return;
                }
        
                if (value?.GetType() == typeof(string))
                {
                    DefaultValueDistance = (string)value;
                    return;
                }
        
                if (value?.GetType() == typeof(Base.Contributor))
                {
                    DefaultValueContributor = (Base.Contributor)value;
                    return;
                }
        
                if (value?.GetType() == typeof(Base.Ratio))
                {
                    DefaultValueRatio = (Base.Ratio)value;
                    return;
                }
        
                if (value?.GetType() == typeof(string))
                {
                    DefaultValueCanonical = (string)value;
                    return;
                }
        
                if (value?.GetType() == typeof(Base.ResourceExpression))
                {
                    DefaultValueExpression = (Base.ResourceExpression)value;
                    return;
                }
        
                if (value?.GetType() == typeof(Base.Signature))
                {
                    DefaultValueSignature = (Base.Signature)value;
                    return;
                }
        
                if (value?.GetType() == typeof(string))
                {
                    DefaultValueUrl = (string)value;
                    return;
                }
        
                if (value?.GetType() == typeof(Base.Annotation))
                {
                    DefaultValueAnnotation = (Base.Annotation)value;
                    return;
                }
        
                if (value?.GetType() == typeof(string))
                {
                    DefaultValueUuid = (string)value;
                    return;
                }
        
                if (value?.GetType() == typeof(Base.Address))
                {
                    DefaultValueAddress = (Base.Address)value;
                    return;
                }
        
                if (value?.GetType() == typeof(string))
                {
                    DefaultValueString = (string)value;
                    return;
                }
        
                if (value?.GetType() == typeof(string))
                {
                    DefaultValueAge = (string)value;
                    return;
                }
        
                if (value?.GetType() == typeof(string))
                {
                    DefaultValueOid = (string)value;
                    return;
                }
        
                if (value?.GetType() == typeof(Base.UsageContext))
                {
                    DefaultValueUsageContext = (Base.UsageContext)value;
                    return;
                }
        
                if (value?.GetType() == typeof(Base.ParameterDefinition))
                {
                    DefaultValueParameterDefinition = (Base.ParameterDefinition)value;
                    return;
                }
        
                if (value?.GetType() == typeof(string))
                {
                    DefaultValueDateTime = (string)value;
                    return;
                }
        
                if (value?.GetType() == typeof(string))
                {
                    DefaultValuePositiveInt = (string)value;
                    return;
                }
        
                if (value?.GetType() == typeof(int))
                {
                    DefaultValueInteger = (int)value;
                    return;
                }
        
                if (value?.GetType() == typeof(string))
                {
                    DefaultValueTiming = (string)value;
                    return;
                }
        
                if (value?.GetType() == typeof(Base.RelatedArtifact))
                {
                    DefaultValueRelatedArtifact = (Base.RelatedArtifact)value;
                    return;
                }
        
                if (value?.GetType() == typeof(Base.Identifier))
                {
                    DefaultValueIdentifier = (Base.Identifier)value;
                    return;
                }
        
                if (value?.GetType() == typeof(Base.CodeableConcept))
                {
                    DefaultValueCodeableConcept = (Base.CodeableConcept)value;
                    return;
                }
    ...
    {
        public required string Name { get; set; }
        public Base.ResourceReference[]? Rule { get; set; }
