...
public class Condition : DomainResource, IResource
{
    ...
    public object? Abatement    
    {
        ...
        set
        {
            if (value?.GetType() == typeof(string))
            {
                AbatementAge = (string)value;
                return;
            }
    
            if (value?.GetType() == typeof(Base.Period))
            {
                AbatementPeriod = (Base.Period)value;
                return;
            }
    
            if (value?.GetType() == typeof(string))
            {
                AbatementString = (string)value;
                return;
            }
    
            if (value?.GetType() == typeof(Base.Range))
            {
                AbatementRange = (Base.Range)value;
                return;
            }
    
            if (value?.GetType() == typeof(string))
            {
                AbatementDateTime = (string)value;
                return;
            }
