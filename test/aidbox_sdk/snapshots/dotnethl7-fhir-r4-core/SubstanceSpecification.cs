...
public class SubstanceSpecification : DomainResource, IResource
{
    ...
    public Base.ResourceReference[]? MolecularWeight { get; set; }
    ...
    public class SubstanceSpecification_Property : BackboneElement
    {
        ...
        public object? Amount    
        {
            ...
            set
            {
                ...
                {
                    AmountQuantity = (Base.Quantity)value;
                    return;
                }
        
                if (value?.GetType() == typeof(string))
                {
                    AmountString = (string)value;
                    return;
                }
        ...
        public object? DefiningSubstance    
        {
            ...
            set
            {
                ...
                {
                    DefiningSubstanceCodeableConcept = (Base.CodeableConcept)value;
                    return;
                }
        
                if (value?.GetType() == typeof(Base.ResourceReference))
                {
                    DefiningSubstanceReference = (Base.ResourceReference)value;
                    return;
                }
    ...
    public class SubstanceSpecification_Name : BackboneElement
    {
        ...
        public Base.ResourceReference[]? Synonym { get; set; }
        public Base.ResourceReference[]? Translation { get; set; }
    ...
    public class SubstanceSpecification_Relationship : BackboneElement
    {
        ...
        public object? Substance    
        {
            ...
            set
            {
                if (value?.GetType() == typeof(Base.CodeableConcept))
                {
                    SubstanceCodeableConcept = (Base.CodeableConcept)value;
                    return;
                }
        
                if (value?.GetType() == typeof(Base.ResourceReference))
                {
                    SubstanceReference = (Base.ResourceReference)value;
                    return;
                }
