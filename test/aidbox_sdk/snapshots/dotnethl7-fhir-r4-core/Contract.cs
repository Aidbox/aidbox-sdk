...
public class Contract : DomainResource, IResource
{
    ...
    public object? Topic    
    {
        ...
        set
        {
            ...
            {
                TopicCodeableConcept = (Base.CodeableConcept)value;
                return;
            }
    
            if (value?.GetType() == typeof(Base.ResourceReference))
            {
                TopicReference = (Base.ResourceReference)value;
                return;
            }
    ...
    public object? LegallyBinding    
    {
        ...
        set
        {
            ...
            {
                LegallyBindingAttachment = (Base.Attachment)value;
                return;
            }
    
            if (value?.GetType() == typeof(Base.ResourceReference))
            {
                LegallyBindingReference = (Base.ResourceReference)value;
                return;
            }
    ...
    public class Contract_Rule : BackboneElement
    {
        public object? Content    
        {
            ...
            set
            {
                if (value?.GetType() == typeof(Base.ResourceReference))
                {
                    ContentReference = (Base.ResourceReference)value;
                    return;
                }
        
                if (value?.GetType() == typeof(Base.Attachment))
                {
                    ContentAttachment = (Base.Attachment)value;
                    return;
                }
    ...
    public class Contract_Term_Asset_ValuedItem : BackboneElement
    {
        ...
        public object? Entity    
        {
            ...
            set
            {
                if (value?.GetType() == typeof(Base.CodeableConcept))
                {
                    EntityCodeableConcept = (Base.CodeableConcept)value;
                    return;
                }
        
                if (value?.GetType() == typeof(Base.ResourceReference))
                {
                    EntityReference = (Base.ResourceReference)value;
                    return;
                }
    ...
    public class Contract_Term_Asset : BackboneElement
    {
        ...
        public Base.ResourceReference[]? Answer { get; set; }
    ...
    {
        public Base.ResourceReference[]? Group { get; set; }
        public Base.Period? Applies { get; set; }
