    ...
    public class ImplementationGuide_Definition_Page : BackboneElement
    {
        public object? Name    
        {
            ...
            set
            {
                ...
                {
                    NameUrl = (string)value;
                    return;
                }
        
                if (value?.GetType() == typeof(Base.ResourceReference))
                {
                    NameReference = (Base.ResourceReference)value;
                    return;
                }
        ...
        public Base.ResourceReference[]? Page { get; set; }
    ...
    public class ImplementationGuide_Definition_Resource : BackboneElement
    {
        ...
        public object? Example    
        {
            ...
            set
            {
                ...
                {
                    ExampleBoolean = (bool)value;
                    return;
                }
        
                if (value?.GetType() == typeof(string))
                {
                    ExampleCanonical = (string)value;
                    return;
                }
