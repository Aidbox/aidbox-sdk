    ...
    public class Task_Output : BackboneElement
    {
        ...
        public object? Value    
        {
            ...
            set
            {
                ...
                {
                    ValueBase64Binary = (string)value;
                    return;
                }
        
                if (value?.GetType() == typeof(string))
                {
                    ValueAge = (string)value;
                    return;
                }
        
                if (value?.GetType() == typeof(Base.ParameterDefinition))
                {
                    ValueParameterDefinition = (Base.ParameterDefinition)value;
                    return;
                }
        
                if (value?.GetType() == typeof(string))
                {
                    ValueTiming = (string)value;
                    return;
                }
                ...
                {
                    ValueContributor = (Base.Contributor)value;
                    return;
                }
        
                if (value?.GetType() == typeof(Base.ContactDetail))
                {
                    ValueContactDetail = (Base.ContactDetail)value;
                    return;
                }
                ...
                {
                    ValueUsageContext = (Base.UsageContext)value;
                    return;
                }
                ...
                if (value?.GetType() == typeof(string))
                {
                    ValueCanonical = (string)value;
                    return;
                }
        
                if (value?.GetType() == typeof(string))
                {
                    ValueMarkdown = (string)value;
                    return;
                }
        
                if (value?.GetType() == typeof(Base.Identifier))
                {
                    ValueIdentifier = (Base.Identifier)value;
                    return;
                }
        
                if (value?.GetType() == typeof(Base.TriggerDefinition))
                {
                    ValueTriggerDefinition = (Base.TriggerDefinition)value;
                    return;
                }
                ...
                if (value?.GetType() == typeof(string))
                {
                    ValueDuration = (string)value;
                    return;
                }
        
                if (value?.GetType() == typeof(Base.DataRequirement))
                {
                    ValueDataRequirement = (Base.DataRequirement)value;
                    return;
                }
        
                if (value?.GetType() == typeof(Base.Meta))
                {
                    ValueMeta = (Base.Meta)value;
                    return;
                }
                ...
                {
                    ValueExpression = (Base.ResourceExpression)value;
                    return;
                }
        
                if (value?.GetType() == typeof(Base.SampledData))
                {
                    ValueSampledData = (Base.SampledData)value;
                    return;
                }
        
                if (value?.GetType() == typeof(string))
                {
                    ValueDosage = (string)value;
                    return;
                }
        
                if (value?.GetType() == typeof(Base.ContactPoint))
                {
                    ValueContactPoint = (Base.ContactPoint)value;
                    return;
                }
                ...
                {
                    ValueAnnotation = (Base.Annotation)value;
                    return;
                }
        
                if (value?.GetType() == typeof(Base.Period))
                {
                    ValuePeriod = (Base.Period)value;
                    return;
                }
        
                if (value?.GetType() == typeof(string))
                {
                    ValueDistance = (string)value;
                    return;
                }
                ...
                {
                    ValueSignature = (Base.Signature)value;
                    return;
                }
        
                if (value?.GetType() == typeof(string))
                {
                    ValueUuid = (string)value;
                    return;
                }
                ...
                {
                    ValueHumanName = (Base.HumanName)value;
                    return;
                }
        
                if (value?.GetType() == typeof(uint))
                {
                    ValueUnsignedInt = (uint)value;
                    return;
                }
                ...
                if (value?.GetType() == typeof(string))
                {
                    ValueOid = (string)value;
                    return;
                }
        
                if (value?.GetType() == typeof(Base.Address))
                {
                    ValueAddress = (Base.Address)value;
                    return;
                }
        
                if (value?.GetType() == typeof(Base.RelatedArtifact))
                {
                    ValueRelatedArtifact = (Base.RelatedArtifact)value;
                    return;
                }
        
                if (value?.GetType() == typeof(string))
                {
                    ValuePositiveInt = (string)value;
                    return;
                }
