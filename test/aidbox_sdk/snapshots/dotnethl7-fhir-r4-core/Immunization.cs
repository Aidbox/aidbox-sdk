    ...
    public class Immunization_ProtocolApplied : BackboneElement
    {
        ...
        public object? DoseNumber    
        {
            ...
            set
            {
                if (value?.GetType() == typeof(string))
                {
                    DoseNumberPositiveInt = (string)value;
                    return;
                }
        
                if (value?.GetType() == typeof(string))
                {
                    DoseNumberString = (string)value;
                    return;
                }
        ...
        public object? SeriesDoses    
        {
            ...
            set
            {
                if (value?.GetType() == typeof(string))
                {
                    SeriesDosesPositiveInt = (string)value;
                    return;
                }
        
                if (value?.GetType() == typeof(string))
                {
                    SeriesDosesString = (string)value;
                    return;
                }
