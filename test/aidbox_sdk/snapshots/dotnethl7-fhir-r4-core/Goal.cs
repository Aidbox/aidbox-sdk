...
public class Goal : DomainResource, IResource
{
    ...
    public object? Start    
    {
        ...
        set
        {
            ...
            {
                StartCodeableConcept = (Base.CodeableConcept)value;
                return;
            }
    ...
    public class Goal_Target : BackboneElement
    {
        ...
        public object? Detail    
        {
            ...
            set
            {
                ...
                {
                    DetailInteger = (int)value;
                    return;
                }
        
                if (value?.GetType() == typeof(string))
                {
                    DetailString = (string)value;
                    return;
                }
        
                if (value?.GetType() == typeof(Base.Ratio))
                {
                    DetailRatio = (Base.Ratio)value;
                    return;
                }
