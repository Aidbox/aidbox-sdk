    ...
    public class Questionnaire_Item_EnableWhen : BackboneElement
    {
        ...
        public object? Answer    
        {
            ...
            set
            {
                ...
                {
                    AnswerQuantity = (Base.Quantity)value;
                    return;
                }
        
                if (value?.GetType() == typeof(string))
                {
                    AnswerDecimal = (string)value;
                    return;
                }
                ...
                {
                    AnswerReference = (Base.ResourceReference)value;
                    return;
                }
        
                if (value?.GetType() == typeof(int))
                {
                    AnswerInteger = (int)value;
                    return;
                }
        
                if (value?.GetType() == typeof(string))
                {
                    AnswerDateTime = (string)value;
                    return;
                }
                ...
                {
                    AnswerBoolean = (bool)value;
                    return;
                }
        
                if (value?.GetType() == typeof(Base.Coding))
                {
                    AnswerCoding = (Base.Coding)value;
                    return;
                }
        
                if (value?.GetType() == typeof(string))
                {
                    AnswerTime = (string)value;
                    return;
                }
