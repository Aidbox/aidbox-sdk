...
public class ServiceRequest : DomainResource, IResource
{
    ...
    public object? AsNeeded    
    {
        ...
        set
        {
            ...
            {
                AsNeededBoolean = (bool)value;
                return;
            }
    
            if (value?.GetType() == typeof(Base.CodeableConcept))
            {
                AsNeededCodeableConcept = (Base.CodeableConcept)value;
                return;
            }
    ...
    public object? Quantity    
    {
        ...
        set
        {
            ...
            {
                QuantityRatio = (Base.Ratio)value;
                return;
            }
    
            if (value?.GetType() == typeof(Base.Range))
            {
                QuantityRange = (Base.Range)value;
                return;
            }
    
            if (value?.GetType() == typeof(Base.Quantity))
            {
                QuantityQuantity = (Base.Quantity)value;
                return;
            }
